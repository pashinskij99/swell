...
export default class WindLayer extends Abstract {
  ...
  static vertexShader = `   
    ...
    vec3 main() {
      ...
      vec2 noise = (lamina_noise_fade(baseGP.xyz * 0.1 + u_time * 0.5 * u_sway)).xz ;
      ...
      // float swingX = sin(u_time) *  pow(pos.z, 2.0);
      // float swingY = sin(u_time) * pow(pos.z, 2.0);
  ...
  constructor(props: any) {
    super(WindLayer as unknown as any, {
      name: 'GrassLayer',
      ...props,
    })
  }
